...
export class UpdateIds1735751270204 implements MigrationInterface {
    name = 'UpdateIds1735751270204'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "therapist" DROP CONSTRAINT "REL_4e9ac749c7bd07e0271f8573b3"`);
        await queryRunner.query(`ALTER TABLE "therapist" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "appointments" ADD "sessionRecordId" uuid`);
        await queryRunner.query(`ALTER TABLE "appointments" ADD CONSTRAINT "UQ_6bfa934e13b936a152b29927b75" UNIQUE ("sessionRecordId")`);
        ...
        await queryRunner.query(`ALTER TABLE "session_records" ADD CONSTRAINT "UQ_26e624cdcfee03c89f2b578953a" UNIQUE ("appointmentId")`);
        ...
        await queryRunner.query(`ALTER TABLE "appointments" ADD CONSTRAINT "FK_6bfa934e13b936a152b29927b75" FOREIGN KEY ("sessionRecordId") REFERENCES "session_records"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "appointments" DROP CONSTRAINT "FK_6bfa934e13b936a152b29927b75"`);
        await queryRunner.query(`ALTER TABLE "appointments" DROP CONSTRAINT "FK_c4dbd8eb292b83b5dc67be3cf45"`);
        await queryRunner.query(`ALTER TABLE "appointments" DROP CONSTRAINT "FK_e450b4d7946df3bc8225add4941"`);
        await queryRunner.query(`ALTER TABLE "session_records" DROP CONSTRAINT "FK_26e624cdcfee03c89f2b578953a"`);
        await queryRunner.query(`ALTER TABLE "therapist_availability" DROP CONSTRAINT "FK_b7af54d3323cd673272c95f168e"`);
        ...
        await queryRunner.query(`ALTER TABLE "appointments" ADD CONSTRAINT "FK_e450b4d7946df3bc8225add4941" FOREIGN KEY ("therapistId") REFERENCES "therapist"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "session_records" DROP CONSTRAINT "UQ_26e624cdcfee03c89f2b578953a"`);
        await queryRunner.query(`ALTER TABLE "session_records" ADD CONSTRAINT "FK_26e624cdcfee03c89f2b578953a" FOREIGN KEY ("appointmentId") REFERENCES "appointments"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "clients" DROP CONSTRAINT "PK_f1ab7cf3a5714dbc6bb4e1c28a4"`);
        await queryRunner.query(`ALTER TABLE "clients" DROP COLUMN "id"`);
        ...
        await queryRunner.query(`ALTER TABLE "therapist_services" ADD CONSTRAINT "FK_23aa7f2a2f464c5353110553711" FOREIGN KEY ("therapistId") REFERENCES "therapist"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "appointments" DROP CONSTRAINT "UQ_6bfa934e13b936a152b29927b75"`);
        await queryRunner.query(`ALTER TABLE "appointments" DROP COLUMN "sessionRecordId"`);
        await queryRunner.query(`ALTER TABLE "therapist" ADD "userId" uuid`);
        await queryRunner.query(`ALTER TABLE "therapist" ADD CONSTRAINT "REL_4e9ac749c7bd07e0271f8573b3" UNIQUE ("userId")`);
